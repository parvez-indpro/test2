...
import makeSelectBasicForms from './selectors';
import reducer from './reducer';
import saga from './saga';

export function BasicForms() {
  useInjectReducer({ key: 'basicForms', reducer });
  useInjectSaga({ key: 'basicForms', saga });
...
const mapStateToProps = createStructuredSelector({
  basicForms: makeSelectBasicForms(),
});
...
export default compose(withConnect)(BasicForms);
