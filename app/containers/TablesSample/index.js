...
import makeSelectTablesSample from './selectors';
...
export function TablesSample() {
  useInjectReducer({ key: 'tablesSample', reducer });
  useInjectSaga({ key: 'tablesSample', saga });
...
const mapStateToProps = createStructuredSelector({
  tablesSample: makeSelectTablesSample(),
});
...
export default compose(withConnect)(TablesSample);
